...
# from radius_evaluation_tools import single_compute_relaxation_radius_multiclass_accuracy, single_compute_relaxation_radius_multiclass
...
from radius_evaluation_tools_torch import compute_certificate, single_compute_relaxation_radius_multiclass, single_compute_relaxation_radius_multiclass_accuracy
...
if __name__ == "__main__":
    ...
    lip_radius = compute_certificate(images.to(device), model)
    # print(lip_radius[:10])
    # import clke
    # 1. Define paths and parameters
    input_csv_path = "/home/aws_install/robustess_project/lip_notebooks/data/Radius_Data/Radius_CIFAR10_VGG.csv"
    output_csv_path = "/home/aws_install/robustess_project/lip_notebooks/data/Radius_Data/Radius_CIFAR10_VGG_Relaxation_complete.csv"
    output_pkl_path = "/home/aws_install/robustess_project/lip_notebooks/data/Radius_Data/Radius_CIFAR10_VGG_Relaxation_complete.pkl"
