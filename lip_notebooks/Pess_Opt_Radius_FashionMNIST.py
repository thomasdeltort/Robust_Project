...
if __name__ == "__main__":
    # Load Dataset
    print("loading Data :")
    x_train, x_test, y_train, y_test, y_test_ord = load_data("FMNIST")
    # Load Model
    print("Loading Model :")
    vanilla_model = keras.models.load_model("/home/aws_install/robustess_project/lip_models/demo4_vanilla_fashionMNIST_channelfirst.keras")
    ...
    with open("/home/aws_install/robustess_project/lip_notebooks/data/Radius_Data/eps_PGD_FMNIST.pkl", "wb") as f:
    ...
    with open("/home/aws_install/robustess_project/lip_notebooks/data/Radius_Data/eps_AA_FMNIST.pkl", "wb") as f:
    ...
    #CSV
    df.to_csv("/home/aws_install/robustess_project/lip_notebooks/data/Radius_Data/Radius_FMNIST.csv", index=False)  
    #Pickle
    df.to_pickle("/home/aws_install/robustess_project/lip_notebooks/data/Radius_Data/Radius_FMNIST.pkl")
